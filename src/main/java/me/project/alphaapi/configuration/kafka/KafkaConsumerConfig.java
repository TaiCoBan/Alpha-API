...
class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, ProductDTO> userConsumerFactory() {
        Map<String, Object> props = new HashMap<>();
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, bootstrapServers);
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, ProductDTO> userKafkaListenerContainerFactory() {
